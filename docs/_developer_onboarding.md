...
[Renovate](https://github.com/apps/renovate) is set up on the project. This tool will automatically create Pull Requests to upgrade our dependencies one by one. Renovate dependency management PRs are maintained directly within this repository.
